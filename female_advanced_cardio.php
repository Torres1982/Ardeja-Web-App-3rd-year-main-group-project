...
<head>
    ...
    <title>Female Advanced Level Cardio </title>
...
<div class="row" id="formField">
    <div class="col-md-12">
        <div class="col-md-12">
            <form role="form" method="POST" action="female_advanced_cardio.php">
                <div class="row">
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox1" value="">Air Bike [5 x 8]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox2" value="">Bottoms Up [4 x 8]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox3" value="">Side Raise [4 x 6]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox4" value="">Drag Curl [4 x 6]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                    ...
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox6" value="">Tread Mill [12 min]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox7" value="">Full Squat [3 x 8]</label>
                        </div>
                    </div>
