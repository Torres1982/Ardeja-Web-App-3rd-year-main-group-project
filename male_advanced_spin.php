...
<html lang="en">
    <head>
        ...
        <title> Male Advanced Level Spin </title>
            <style>
...
<div class="row" id="formField">
    <div class="col-md-12">
        <div class="col-md-12">
            <form role="form" method="POST" action="male_advanced_spin.php">
                <div class="row">
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox1" value="">Reverse Crunch [6 x 12]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox2" value="">BackWard Drag [6 x 12]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox3" value="">Cable Crossovers [5 x 10]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox4" value="">OverHead Triceps [4 x 8]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox5" value="">Chest Throw [4 x 10]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox6" value="">Battling Ropes [3 x 10]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox7" value="">Full Squat [4 min]</label>
                        </div>
                    </div>
