...
<html lang="en">
    <head>
        ...
        <title> Male Beginner Level Cardio </title>
        <style>
            ...
            <form role="form" method="POST" action="male_begin_cardio.php">
                <div class="row">
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox1" value="">Dumbbell Press [2 x 8]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox2" value="">Overhead Triceps [2 x 6]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox3" value="">Chest Throw [2 x 6]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox4" value="">Incline Bench Pull [2 x 5]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox5" value="">Full Squat [2x10]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox6" value="">Ball Leg Curl [2x5]</label>
                        </div>
                    </div>
                    <div class="form-group col-md-4 col-md-offset-4">
                        <div class="checkbox">
                            <label><input type="checkbox" name="checkbox7" value="">Drag Curl [3x8]</label>
                        </div>
                    </div>
