...
<head>
    ...
    <title> Display Users Activities </title>
...
<div class="container" id="progressTable">
    <div class="row">
        <div class="col-md-12">
            <h2 class="yellow"> Display Users' Activities </h2>
            <table class="table">
                <thead>
                    <tr>
                        <th> User ID</th>
                ...
                <?php
					...
					$sql = "SELECT user_id, level, type, date, complete, exerciseid FROM exercise_list";
					...
					if (mysqli_num_rows($result) > 0) {
						while ($row = mysqli_fetch_array($result)) {
							echo " <tr>
								...
								<td class='yellow'> " . $row["level"] . " </td>
								<td class='yellow'> " . $row["type"] . " </td>
								<td  class='yellow'> " . $row["date"] . " </td>
								<td class='yellow'> " . $row["complete"] . " </td>
								<td class='yellow'> " . $row["exerciseid"] . " </td>
							</tr>";
						}
					}
					mysqli_close($conn);
